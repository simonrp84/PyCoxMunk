...
==================================
pycoxmunk: A library for estimating satellite-viewed sea surface reflectances
...
of white caps and other wind related wave effects. A spectral database of water properties is included, allowing
...
`pycoxmunk` is designed to work in tandem with the `satpy library <https://github.com/pytroll/satpy>`_ that reads data
